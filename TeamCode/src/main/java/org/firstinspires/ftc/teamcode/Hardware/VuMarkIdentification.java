...
public class VuMarkIdentification {
    ...
    public void decodePictograph () throws InterruptedException {
        int count = 0; // need at least 5000000 limit to detect pictograph with cameramonitor on.
        // camera needs to be angled toward pictograph
        // takes about 4 seconds to detect pictograph
        // takes about 2 seconds to detect pictograph with cameramontior off
        while (vuMark == RelicRecoveryVuMark.UNKNOWN && count < 2000000) {
            count++;
