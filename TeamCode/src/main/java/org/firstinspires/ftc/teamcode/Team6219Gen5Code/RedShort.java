...
@Autonomous (name="Autonomous : RedShort", group="PantherbotV5")
public class RedShort extends LinearOpMode {
    ...
    public void backToEndBlue(double dist){
        while(getLeftDist() > dist){
            robot.motorRightFront.setPower(-.2);
            robot.motorLeftFront.setPower(-.2);
            robot.motorRightBack.setPower(-.2);
            robot.motorLeftBack.setPower(-.2);
    ...
    public void hitForward(){
        ...
        sleep(200);
        robot.horizontalArm.setPosition(0.33);
        sleep(200);
        robot.verticalArm.setPosition(0.4);
        sleep(300);
    ...
    public void hitBackward(){
        ...
        sleep(300);
        robot.horizontalArm.setPosition(0.5);
        sleep(200);
        robot.verticalArm.setPosition(0.7);
        sleep(200);
    }
    ...
    public double getRightDist(){
        ...
        double cur = -1;
        for(int i = 0; i < 1; i++){
            cur = robot.rangeSensor1.getDistance(DistanceUnit.CM);
            reading += cur;
            sleep(1);
        }
        return reading;
    ...
    public boolean detectLeftEdge(){
        ...
        if(Math.abs(cur) / distanceToWall > 0.37) return true;
        return false;
    }
    ...
    public void DriveToColumnRed(int vu){
        ...
        while(count != vu && opModeIsActive()){
            ...
            robot.motorLeftFront.setPower(0.12);
            robot.motorRightBack.setPower(0.12);
            robot.motorLeftBack.setPower(-0.12);
