...
public class MRColorSensor extends I2cControllerPortDeviceImpl implements ColorSensor, I2cController.I2cPortReadyCallback {
    ...
    public MRColorSensor(I2cController module, int physicalPort) {
